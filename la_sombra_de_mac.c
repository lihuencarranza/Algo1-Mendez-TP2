...
*/
void obtener_herramientas(juego_t* juego){
    ...
    //NIVEL UNO
    generar_herramienta(juego->niveles[0].herramientas, &juego->niveles[0].tope_herramientas, juego->niveles[0].obstaculos, juego->niveles[0].tope_obstaculos, juego->niveles[0].paredes, juego->niveles[0].tope_paredes, CANTIDAD_ESCALERAS_1, ESCALERA);
    ...
    generar_herramienta(juego->niveles[0].herramientas, &juego->niveles[0].tope_herramientas, juego->niveles[0].obstaculos, juego->niveles[0].tope_obstaculos, juego->niveles[0].paredes, juego->niveles[0].tope_paredes, CANTIDAD_MONEDAS_1, MONEDA);

    //NIVEL DOS
    generar_herramienta(juego->niveles[1].herramientas, &juego->niveles[1].tope_herramientas, juego->niveles[1].obstaculos, juego->niveles[1].tope_obstaculos, juego->niveles[1].paredes, juego->niveles[1].tope_paredes, CANTIDAD_ESCALERAS_2, ESCALERA);
    ...
    generar_herramienta(juego->niveles[1].herramientas, &juego->niveles[1].tope_herramientas, juego->niveles[1].obstaculos, juego->niveles[1].tope_obstaculos, juego->niveles[1].paredes, juego->niveles[1].tope_paredes, CANTIDAD_LLAVE, LLAVE);
    generar_herramienta(juego->niveles[1].herramientas, &juego->niveles[1].tope_herramientas, juego->niveles[1].obstaculos, juego->niveles[1].tope_obstaculos, juego->niveles[1].paredes, juego->niveles[1].tope_paredes, CANTIDAD_MONEDAS_2, MONEDA);

    //NIVEL TRES
    generar_herramienta(juego->niveles[2].herramientas, &juego->niveles[2].tope_herramientas, juego->niveles[2].obstaculos, juego->niveles[2].tope_obstaculos, juego->niveles[2].paredes, juego->niveles[2].tope_paredes, CANTIDAD_ESCALERAS_2, ESCALERA);
    ...
    generar_herramienta(juego->niveles[2].herramientas, &juego->niveles[2].tope_herramientas, juego->niveles[2].obstaculos, juego->niveles[2].tope_obstaculos, juego->niveles[2].paredes, juego->niveles[2].tope_paredes, CANTIDAD_LLAVE, LLAVE);
    generar_herramienta(juego->niveles[2].herramientas, &juego->niveles[2].tope_herramientas, juego->niveles[2].obstaculos, juego->niveles[2].tope_obstaculos, juego->niveles[2].paredes, juego->niveles[2].tope_paredes, CANTIDAD_MONEDAS_2, MONEDA);
} 
...
*/
void obtener_obstaculos(juego_t* juego){
    ...
    //NIVEL UNO
    generar_obstaculo(juego->niveles[0].obstaculos, &juego->niveles[0].tope_obstaculos, juego->niveles[0].herramientas, juego->niveles[0].tope_herramientas, juego->niveles[0].paredes, juego->niveles[0].tope_paredes, CANT_INTERRUPTORES_1, INTERRUPTOR);
    generar_obstaculo(juego->niveles[0].obstaculos, &juego->niveles[0].tope_obstaculos, juego->niveles[0].herramientas, juego->niveles[0].tope_herramientas, juego->niveles[0].paredes, juego->niveles[0].tope_paredes, CANT_POZOS_1, POZO);
    generar_obstaculo(juego->niveles[0].obstaculos, &juego->niveles[0].tope_obstaculos, juego->niveles[0].herramientas, juego->niveles[0].tope_herramientas, juego->niveles[0].paredes, juego->niveles[0].tope_paredes, CANT_VELAS_1, VELA); 

    //NIVEL DOS
    generar_obstaculo(juego->niveles[1].obstaculos, &juego->niveles[1].tope_obstaculos, juego->niveles[1].herramientas, juego->niveles[1].tope_herramientas, juego->niveles[1].paredes, juego->niveles[1].tope_paredes, CANT_INTERRUPTORES_2, INTERRUPTOR);
    generar_obstaculo(juego->niveles[1].obstaculos, &juego->niveles[1].tope_obstaculos, juego->niveles[1].herramientas, juego->niveles[1].tope_herramientas, juego->niveles[1].paredes, juego->niveles[1].tope_paredes, CANT_POZOS_2, POZO);
    generar_obstaculo(juego->niveles[1].obstaculos, &juego->niveles[1].tope_obstaculos, juego->niveles[1].herramientas, juego->niveles[1].tope_herramientas, juego->niveles[1].paredes, juego->niveles[1].tope_paredes, CANT_VELAS_2, VELA);
    generar_obstaculo(juego->niveles[1].obstaculos, &juego->niveles[1].tope_obstaculos, juego->niveles[1].herramientas, juego->niveles[1].tope_herramientas, juego->niveles[1].paredes, juego->niveles[1].tope_paredes, CANT_PORTALES_2, PORTAL);

    //NIVEL TRES
    generar_obstaculo(juego->niveles[2].obstaculos, &juego->niveles[2].tope_obstaculos, juego->niveles[2].herramientas, juego->niveles[2].tope_herramientas, juego->niveles[2].paredes, juego->niveles[2].tope_paredes, CANT_INTERRUPTORES_3, INTERRUPTOR);
    generar_obstaculo(juego->niveles[2].obstaculos, &juego->niveles[2].tope_obstaculos, juego->niveles[2].herramientas, juego->niveles[2].tope_herramientas, juego->niveles[2].paredes, juego->niveles[2].tope_paredes, CANT_POZOS_3, POZO);
    generar_obstaculo(juego->niveles[2].obstaculos, &juego->niveles[2].tope_obstaculos, juego->niveles[2].herramientas, juego->niveles[2].tope_herramientas, juego->niveles[2].paredes, juego->niveles[2].tope_paredes, CANT_VELAS_3, VELA);
    generar_obstaculo(juego->niveles[2].obstaculos, &juego->niveles[2].tope_obstaculos, juego->niveles[2].herramientas, juego->niveles[2].tope_herramientas, juego->niveles[2].paredes, juego->niveles[2].tope_paredes, CANT_PORTALES_3, PORTAL);
...
void inicializar_juego(juego_t* juego){
    ...
    obtener_herramientas(juego);
    obtener_obstaculos(juego);
...
void interaccion_puerta(juego_t* juego, char movimiento){
    for(int i = 0; i < juego->niveles[juego->nivel_actual-1].tope_herramientas; i++){
        if(juego->niveles[0].herramientas[i].tipo == PUERTA  && distancia_manhatann(juego->personaje.posicion, juego->niveles[0].herramientas[i].coordenada) <= 1 && distancia_manhatann(juego->sombra.posicion, juego->niveles[0].herramientas[i].coordenada)){
            juego->nivel_actual += 1; 
            juego->niveles[juego->nivel_actual].numero_nivel += 1;
            estado_nivel(*juego);
        
        }
        
        if(juego->niveles[juego->nivel_actual-1].herramientas[i].tipo == PUERTA  && distancia_manhatann(juego->personaje.posicion, juego->niveles[juego->nivel_actual-1].herramientas[juego->nivel_actual-1].coordenada) <= 1){
            juego->nivel_actual += 1; 
            juego->niveles[juego->nivel_actual].numero_nivel += 1;
            estado_nivel(*juego);
        }
